                    ...
                    <div className="relative flex items-center justify-between h-20">
                        ...
                        >
                            <div className="relative">
                                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-green-500/20 to-cyan-500/20 border border-green-500/30 flex items-center justify-center group-hover:scale-105 transition-transform">
                                    <span className="text-green-400 font-bold text-xl">C</span>
                                </div>
                            ...
                            <div>
                                ...
                                <div className="text-xs text-gray-500 font-mono">Builder + Breaker</div>
                            </div>
                        </div>
