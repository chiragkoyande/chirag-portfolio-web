...
import { Download, Award, Terminal, Linkedin, Github } from 'lucide-react';
...
const About: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center pb-24 overflow-y-auto">

      {/* Hero Section */}
      <section className="w-full max-w-5xl px-4 pt-8 pb-16">
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
          ...
          <div className="relative w-full md:w-64 h-64 shrink-0 mx-auto md:mx-0">
            ...
            <div className="absolute inset-2 bg-black overflow-hidden grayscale contrast-125 brightness-75 group">
              <img src="/images/chirag-profile.jpg" alt="Chirag Koyande" className="object-cover w-full h-full opacity-80 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <ShatteredCard>
              ...
              <div className="mt-6 flex gap-3">
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-gray-400 hover:text-white hover:border-white/30 transition-all"
                >
                  <Github size={16} />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/30 rounded-lg text-blue-400 hover:text-blue-300 hover:border-blue-400 transition-all"
                >
                  <Linkedin size={16} />
      ...
      {/* Skills Section - Unique Typing Style */}
      <SkillsSection />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {CERTIFICATIONS_DATA.map((cert) => (
                <ShatteredCard key={cert.id} intensity="low" className="group cursor-default">
                  <div className="flex justify-between items-start">
                    ...
                    <span className={`text-[10px] px-1.5 py-0.5 border ${cert.level === 'Expert' ? 'border-red-500/50 text-red-400' :
          ...
          <div className="md:col-span-1 flex flex-col gap-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <GlitchText text="RESUME" as="h3" className="text-xl font-display font-bold text-white" />
            </div>
            ...
            <ShatteredCard className="flex-1 flex flex-col justify-center items-center text-center space-y-4">
              ...
              <button
                ...
                className="group relative px-6 py-3 bg-green-900/20 border border-green-500/50 overflow-hidden w-full transition-all hover:bg-green-500/10 hover:border-green-400 hover:shadow-[0_0_20px_rgba(74,222,128,0.2)] rounded-lg"
              >
