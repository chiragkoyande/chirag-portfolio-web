...
const Contact: React.FC = () => {
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center pt-20 pb-64 px-4 overflow-y-auto">
      <div className="max-w-2xl w-full">
        <div className="mb-8 text-center">
           <GlitchText text="ESTABLISH_UPLINK" as="h2" className="text-4xl font-display font-bold text-white" />
           <p className="font-mono text-green-500/60 mt-2 text-sm flex items-center justify-center gap-2">
